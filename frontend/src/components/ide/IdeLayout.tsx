...
export default function IdeLayout() {
    ...
    return (
        <div ref={containerRef} className="h-screen w-full bg-[#1e1e1e] text-[#cccccc] overflow-hidden flex flex-col">
            <div className="flex-1 flex overflow-hidden">
                {/* Sidebar */}
                {isSidebarOpen && (
                    <>
                        <div
                            className="h-full bg-[#252526] border-r border-[#3c3c3c] overflow-hidden"
                        ...
                        <div
                            className="w-1 h-full bg-[#3c3c3c] hover:bg-[#007acc] cursor-col-resize transition-colors flex-shrink-0"
                ...
                <div className="flex-1 flex flex-col overflow-hidden">
                    ...
                    {isTerminalOpen && (
                        <>
                            ...
                            <div
                                className="h-1 w-full bg-[#3c3c3c] hover:bg-[#007acc] cursor-row-resize transition-colors flex-shrink-0"
            ...
            {/* Status Bar */}
            <div className="h-6 bg-[#007acc] border-t border-[#3c3c3c] flex items-center px-3 text-[10px] text-white select-none justify-between flex-shrink-0">
